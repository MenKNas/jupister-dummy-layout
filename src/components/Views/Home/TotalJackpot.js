...
export default function TotalJackpot() {
  return (
    <div className="px-4">
      <div className="hidden lg:flex flex-col lg:w-4/5 mx-auto py-4 text-center dark:bg-gray-800 dark:text-white justify-center items-center border border-pink-500 space-y-4 uppercase rounded-md">
