...
export default function TotalJackpot() {
  return (
    <div className="hidden lg:flex flex-col w-4/5 mx-auto p-4 text-center bg-gray-800 text-white justify-center items-center border border-pink-500 space-y-4 uppercase rounded-sm">
