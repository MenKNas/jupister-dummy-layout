...
export default function TotalJackpot() {
  return (
    <div className="px-4">
      <div className="hidden lg:flex flex-col lg:w-full mx-auto py-4 text-center bg-gray-800 text-white justify-center items-center border border-pink-500 space-y-4 uppercase rounded-md">
